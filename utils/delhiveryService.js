  ...
  shipments: [
    {
      ...
      seller_add: "Chennai Warehouse Address",
         seller_inv: order?.invoiceNumber || `INV-${order?.orderNumber}`,
     ...
     shipment_width: String(order?.dimensions?.width || 10),
          shipment_height: String(order?.dimensions?.height || 10),
          shipment_length: String(order?.dimensions?.length || 10),
